...
> **[v1.0.0](https://github.com/BlazeFTL/FTL-Patches/releases/tag/v1.0.0)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;6 patches total
<details open>
...
| [Strip Firebase manifest components](#strip-firebase-manifest-components) | Removes Firebase Analytics/Crashlytics receiver and service declarations from AndroidManifest.xml. |  |
