...
> **[v1.20.0-dev.3](https://github.com/BlazeFTL/FTL-Patches/releases/tag/v1.20.0-dev.3)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;7 patches total
<details open>
...
| [Remove all DEX debug info](#remove-all-dex-debug-info) | Removes debug information from every class and method in every processed DEX file. |  |
