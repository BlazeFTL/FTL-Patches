...
> **[v1.20.0-dev.5](https://github.com/BlazeFTL/FTL-Patches/releases/tag/v1.20.0-dev.5)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;7 patches total
<details open>
...
| [Remove all DEX debug info](#remove-all-dex-debug-info) | Removes source-file references and debug-info references from every original DEX without creating mutable Smali methods. |  |
