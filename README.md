...
> **[v1.20.0-dev.4](https://github.com/BlazeFTL/FTL-Patches/releases/tag/v1.20.0-dev.4)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;7 patches total
<details open>
...
| [Remove all DEX debug info](#remove-all-dex-debug-info) | Removes source-file references and debug-info references from every DEX file. |  |
