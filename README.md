...
> **[v1.20.0-dev.2](https://github.com/BlazeFTL/FTL-Patches/releases/tag/v1.20.0-dev.2)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;7 patches total
<details open>
...
| [Remove all DEX debug info](#remove-all-dex-debug-info) | Removes source files, method debug items, and parameter names from every DEX class. |  |
