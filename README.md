...
> **[v1.8.0](https://github.com/BlazeFTL/FTL-Patches/releases/tag/v1.8.0)**&nbsp;&nbsp;•&nbsp;&nbsp;`main`&nbsp;&nbsp;•&nbsp;&nbsp;6 patches total
<details open>
...
|----------|----------------|-----------|
| [APK Junk Cleanup](#apk-junk-cleanup) | Strips build artifacts and metadata (Kotlin modules, version files, protobuf descriptors, library properties) that bloat the APK but are unused at runtime. Optionally keeps native libraries for only one CPU architecture. | • Keep Only One Architecture<br>• Target architecture |
