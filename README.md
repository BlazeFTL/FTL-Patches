...
<!-- PATCHES_START -->
> **[v1.44.0-dev.17](https://github.com/BlazeFTL/FTL-Patches/releases/tag/v1.44.0-dev.17)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;65 patches total
<details>
<summary>📦 MX Player&nbsp;&nbsp;•&nbsp;&nbsp;12 patches</summary>
<br>
...
| [Clean sidebar shortcuts](#clean-sidebar-shortcuts) | Independently hide Video Display, Bookmark, Favourite, Add to Playlist, Tutorial, and/or Playing Queue from the player's shortcut sidebar. | • Hide Bookmark<br>• Hide Favourite<br>• Hide Add to Playlist<br>• Hide Tutorial<br>• Hide Playing Queue |
...
| [Hide Video Display](#hide-video-display) |  | • Hide Video Display |
