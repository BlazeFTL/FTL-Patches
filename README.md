...
> **[v1.20.0-dev.8](https://github.com/BlazeFTL/FTL-Patches/releases/tag/v1.20.0-dev.8)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;7 patches total
<details open>
...
| [Remove debug info](#remove-debug-info) | Zeroes debug_info_off on every method's code_item across all classes*.dex files, stripping line numbers, local variable tables, and source file names. |  |
