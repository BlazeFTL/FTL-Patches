...
<!-- PATCHES_START -->
> **[v1.40.0-dev.2](https://github.com/BlazeFTL/FTL-Patches/releases/tag/v1.40.0-dev.2)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;29 patches total
<details>
...
| [Remove Ads Lite(Adobo)](#remove-ads-lite-adobo) | Based On (Adobo's Block Ads+Mobile Ads) It Should Work Where Remove Ads Patch Caused Problem Safer than Remove Ads for apps where you will be stuck in SplashActivity It Is Weaker But Effective, Merged Adobo's Both Patches And Removed The Need Of Selecting A Host File Or Configuring Anything In Future It May Replace Remove Ads Patch If I Find No Problem. | • Redirection IP<br>• Additional hosts file (optional) |
